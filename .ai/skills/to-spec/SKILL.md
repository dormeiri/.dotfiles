...
2. If applicable, get task description in Port MCP or Port CLI for more context. Get the task identifier from the branch name or ask the user for the if you don't have it.
...
4. Decide the impact of the change on the user:
...
5. Write the spec using [./SPEC_FORMAT.md](./SPEC_FORMAT.md). Write in `specs/` directory if not specified otherwise.
